    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'var(--gc-bg)' }}>
      <div className="w-full max-w-sm">
        ...
        <div className="text-center" style={{ marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 13, color: 'var(--gc-muted)', marginTop: 4 }}>Create your account</p>
        </div>
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="name" style={{ display: 'block', fontSize: 13, fontWeight: 500, color: 'var(--gc-text2)', marginBottom: 6 }}>
                Name <span style={{ color: 'var(--gc-muted)' }}>(optional)</span>
              </label>
              <input
                id="name"
                type="text"
        ...
        <p className="text-center" style={{ fontSize: 13, color: 'var(--gc-muted)', marginTop: 16 }}>
          ...
          <Link to="/login" style={{ color: 'var(--gc-primary)', fontWeight: 600, textDecoration: 'none' }}>
            Sign in
          </Link>
        </p>
      </div>
